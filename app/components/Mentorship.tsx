      ...
      >
          ...
          <div className="space-y-12">
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className={`glass-card rounded-2xl p-6 max-w-md ${i % 2 === 1 ? "md:mr-auto md:ml-0" : "md:ml-auto md:mr-0"} w-full`}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="glass-card glow-border rounded-2xl p-8">
            <p className="text-xs uppercase tracking-[0.3em] text-sky-400/70 mb-4">Program Details</p>
